rm(list = ls())
#Video from : https://www.youtube.com/watch?v=C4N3_XJJ-jU



#######################################################
##   LOGISTIC REGRESSION FOR GETTING PROBABILITIES
######################################################
...
head(data,20) # now we have data and column names
...
logistic <- glm(hd ~ sex, data=data, family="binomial") #Generalized Linear Models.
